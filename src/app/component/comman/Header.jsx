        ...
        <>
            ...
            <header className="w-full bg-white relative z-50 min-h-[80px]">
                <div className="container mx-auto flex items-center justify-between px-4 sm:px-6 lg:px-8 xl:px-2 2xl:px-24">
                    ...
                    {/* Logo */}
                    <div className="flex-shrink-0 pl-2 sm:pl-4 md:pl-4 lg:p-0">
                        <img
                    ...
                    <div className="hidden md:flex gap-5 lg:gap-13 items-center px-6 py-2 whitespace-nowrap">
                        {["HOME", "PRODUCT", "CONTACT US", "SUPPORT", "VISIT COMPANY"].map((item) => (
                            <div
                                key={item}
                    ...
                    {/* Icons + Mobile Toggle */}
                    <div className="flex items-center gap-6 md:gap-6 lg:gap-8 xl:gap-10">
                        {/* Mobile Search */}
                        <BsSearch className="text-black text-xl md:hidden" />
                        {/* Tablet/Desktop Search */}
                        <BsSearch className="text-black text-lg hidden md:block" />

                        {/* Cart */}
                        <FaShoppingCart className="text-black text-lg hidden sm:block" />
